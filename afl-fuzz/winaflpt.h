...
EXTERN_C int run_target_pt(char **argv, uint32_t timeout, uint32_t init_timeout, int drun);
EXTERN_C int pt_init(int argc, const char **argv, char *module_dir);
EXTERN_C void destroy_target_process_pt();
